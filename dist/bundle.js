...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "BufferRW": () => (/* binding */ BufferRW)
/* harmony export */ });
/* harmony import */ var _compute_wgsl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./compute.wgsl */ "./src/BufferRW/compute.wgsl");
/* harmony import */ var _paint_wgsl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./paint.wgsl */ "./src/BufferRW/paint.wgsl");
...
/* harmony import */ var _bufferRW_wgsl__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bufferRW.wgsl */ "./src/BufferRW/bufferRW.wgsl");




var BUFFER_SIZE_X = 256;
var BUFFER_SIZE_Y = 256 - 64;
var WORKGROUP_SIZE = 8;
var BufferRW = /** @class */ (function () {
    function BufferRW(device, context, dimension) {
    ...
    BufferRW.prototype.initialize = function () {
        var _this = this;
        var gui = new dat_gui__WEBPACK_IMPORTED_MODULE_2__.GUI({ name: 'My GUI' });
        var gridSettings = gui.addFolder('Grid Settings');
        this.simParams = {
            resolutionScaling: 1.0,
            speed: 1.0
        };
        var updateSimParams = function () {
            console.log("Changed Params", _this.simParams);
            _this.SPEED = _this.simParams.speed;
        };
        ...
        //Buffer
        var BUFFER_T_SIZE = 1000;
        var bufferT = this.device.createBuffer({
            size: BUFFER_T_SIZE,
        ...
        this.pipeline = this.device.createRenderPipeline({
            ...
            vertex: {
                module: this.device.createShaderModule({
                    code: _bufferRW_wgsl__WEBPACK_IMPORTED_MODULE_3__,
                }),
        ...
        var computeBindGroupLayout = this.device.createBindGroupLayout({
            entries: [
                {
                    binding: 0,
        ...
        this.computePipeline = this.device.createComputePipeline({
            ...
            compute: {
                module: this.device.createShaderModule({
                    code: _compute_wgsl__WEBPACK_IMPORTED_MODULE_0__,
                }),
                entryPoint: 'main',
            },
        });
        this.paintPipeline = this.device.createComputePipeline({
            ...
            compute: {
                module: this.device.createShaderModule({
                    code: _paint_wgsl__WEBPACK_IMPORTED_MODULE_1__,
                }),
                entryPoint: 'main',
            },
        });
        ...
        var centerX = 0.5;
        var centerY = 0.5;
        var mx = 0, mn = 999999999;
        var initialParticleData = new Float32Array(BUFFER_SIZE_X * BUFFER_SIZE_Y * 4);
        for (var i = 0; i < BUFFER_SIZE_X * BUFFER_SIZE_Y * 4; ++i) {
            var xCoord = Math.floor((i / 4) % BUFFER_SIZE_X) / BUFFER_SIZE_X;
            var yCoord = Math.floor((i / 4) / BUFFER_SIZE_X) / BUFFER_SIZE_Y;
        ...
        for (var i = 0; i < 2; ++i) {
            ...
            new Float32Array(this.particleBuffers[i].getMappedRange()).set(initialParticleData);
    ...
    BufferRW.prototype.render = function (frameRate) {
        if (this.paused)
            return;
        var computeTimes = 0;
        if (this.SPEED < 1) {
            var groupName = Math.ceil(1.0 / this.SPEED);
    ...
    BufferRW.prototype.onClick = function (mouseX, mouseY) {
        // this.lastMouseX = mouseX;
        // this.lastMouseY = mouseY;
        // this.lastPressed = true;
    };
    BufferRW.prototype.onDragFinished = function (dx, dy, mouseX, mouseY) {
    };
    BufferRW.prototype.onDrag = function (mouseX, mouseY) {
        this.lastMouseX = mouseX;
        this.lastMouseY = mouseY;
        this.lastPressed = true;
    };
...
/* harmony import */ var _BufferRW_bufferRW__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BufferRW/bufferRW */ "./src/BufferRW/bufferRW.ts");
...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        var canvas, adapter, device, context, dimension, devicePixelRatio, canvasScale, currentProject, lastFrame, numFrames, sumDelta, stats, updateFrame, mouseX, mouseY, isDragging;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    numFrames = 0;
                    sumDelta = 0;
                    currentProject = new _BufferRW_bufferRW__WEBPACK_IMPORTED_MODULE_1__.BufferRW(device, context, dimension);
                    currentProject.initialize();
                    stats = new (stats_js__WEBPACK_IMPORTED_MODULE_2___default())();
